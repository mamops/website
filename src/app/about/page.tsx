...
const team = [
  {
    ...
    bio: "Web, Azure, and interfaces that users actually enjoy. Obsessed with pixel-perfect design and smooth interactions.",
  },
  {
    role: "QA & DevOps Specialist",
    bio: "Automation, pipelines, and reliability. If it can be tested, it will be. If it can fail, it won't.",
  },
];
